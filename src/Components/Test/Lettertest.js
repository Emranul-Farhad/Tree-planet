...
import { motion, useViewportScroll,useScroll, useTransform } from "framer-motion";
...
const letterStyle = {
  ...
  function Letter() {
    ...
    const yPosAnim = useTransform(scrollYProgress, [0, 0.5, 2], [0, -250, -50]);
    ...
    return (
      ...
      >
        ...
        <div style={{ ...frontfaceStyle,  zIndex: ffLayer }}>
          <button onClick={() => window.scrollTo(0,3000)}>Open Me</button>
        </div>
      </motion.div>
    );
  }
